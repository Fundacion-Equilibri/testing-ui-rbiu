...
test.describe("Página de Mercado /mercado (Auth)", () => {
  ...
  //     test("Debería navegar a la página de detalles al hacer clic en un producto", async ({ page }) => {
  //       await productsPage.goto();
  //       await productsPage.searchProduct(product.name);
  ...
  //     test("Debería cargar más productos al hacer clic en 'Ver más'", async ({ page }) => {
  ...
  //       } else {
  //         console.warn("ADVERTENCIA: No hay suficientes productos para probar la paginación.");
  //         test.skip();
  //       }
  //     });
  //   });
